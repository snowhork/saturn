...
export const listStoragesGet = (
  ...
  return axios.default.get(`/storages`, options);
};
...
export const listItemsItemsGet = (
  ...
  return axios.default.get(`/items`, {
    ...options,
    params: { ...params, ...options?.params },
  });
};
...
export const transferTransferPost = (
  ...
  return axios.default.post(`/transfer`, transferRequest, options);
};
...
export const authOauthNameGoogleDriveAuthGet = (
  ...
  return axios.default.get(`/oauth/${name}/google_drive/auth`, {
    ...options,
    params: { ...params, ...options?.params },
  });
};
...
export const callbackOauthNameGoogleDriveCallbackGet = (
  ...
  return axios.default.get(`/oauth/${name}/google_drive/callback`, {
    ...options,
    params: { ...params, ...options?.params },
  });
};
...
export const tokenOauthNameGoogleDriveTokenGet = (
  ...
  return axios.default.get(`/oauth/${name}/google_drive/token`, {
    ...options,
    params: { ...params, ...options?.params },
  });
};
